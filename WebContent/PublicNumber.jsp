...
$(function(){
	...
	$("#dg").datagrid({
		...
		columns:[[
			...
			{field:"public_id",title:"公众号帐号",width:100,align:"center"},
			...
			{field:"address",title:"公众号联系地址",width:100,align:"center"},
		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					...
					<td><select  name="public_type" class="easyui-combobox" style="width: 180" data-options="editable:false"">
				...
				<tr>
					<td class="right">公众号联系地址：</td>
					<td><input type="text" name="address" class="easyui-textbox" data-options="required:true"></td>
				</tr>
				<tr>
					<td class="right">公众号logo图片：</td>
					<td>
						<input id="sc" name="logo" class="easyui-filebox" data-options="buttonText:'选择Logo'">
					</td>
				</tr>
				<tr>
					<td class="right">公众号注册日期：</td>
					<td><input type="date" name="regDate" class="easyui-datebox" data-options="required:true"></td>
				</tr>
