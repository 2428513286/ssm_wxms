		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					...
					<td>	<input id="sc" name="photo" class="easyui-filebox" data-options="buttonText:'选择头像'">
					</td>
				</tr>
				<tr>
					<td class="right">所属角色：</td>
					<td>
						<select  name="role" class="easyui-combobox" style="width: 180" data-options="editable:false"">
