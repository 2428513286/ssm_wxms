...
$(function(){
	...
	$("#dg").datagrid({
		...
		columns:[[
			...
			{field:"tid",title:"内容模版",width:100,align:"center"},
		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					...
					<td><input type="text" name="tid" class="easyui-numberbox" data-options="required:true"></td>
				</tr>
				<tr>
					<td class="right">发布人：</td>
					<td><input type="text" name="user_id" class="easyui-textbox" data-options="required:true,editable:false"></td>
				</tr>
				<tr>
					<td class="right">发布时间：</td>
					<td><input type="Timestamp" name="createTime" class="easyui-datebox" data-options="required:true,editable:false"></td>
				</tr>
