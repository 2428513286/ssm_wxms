			...
			<table style="margin: 0 auto;">
				<tr>
					...
					<td>
					 ...
					 <!-- <input type="text" name="pid" class="easyui-textbox" data-options="required:true">  -->
					 <input type="text" class="easyui-combobox" name="pid" 
 						data-options="valueField:'pid',textField:'name',url:'user/uqueryByName'" />
				...
				<tr>
					...
					<td>
						...
						<!--  <input type="text" name="user_id" class="easyui-textbox" data-options="required:true">  -->
						 ...
						 <input type="text" class="easyui-combobox" name="user_id" 
	 						data-options="valueField:'user_id',textField:'public_name',url:'publicNumber/uqueryAll'
	 						" /> 
				...
				<tr>
					...
					<td><input type="date" name="applyTime" class="easyui-datebox" data-options="required:true"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<select  name="state" class="easyui-combobox" style="width: 180" data-options="editable:false"">
