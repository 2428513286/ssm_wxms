		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					...
					<td><input type="text" name="addFans" class="easyui-textbox" data-options="required:true"></td>
				</tr>
				<tr>
					<td class="right">减少粉丝数：</td>
					<td><input type="text" name="reduceFans" class="easyui-textbox" data-options="required:true"></td>
				</tr>
				<tr>
					<td class="right">统计日期：</td>
					<td><input type="date" name="countDate" class="easyui-textbox" data-options="required:true"></td>
				</tr>
